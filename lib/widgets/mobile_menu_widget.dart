                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: ListTile(
                        leading: Text('01',style: TextStyle(color: Colors.grey)),
                    ...
                    DropDownMenu(title: 'Categories',number: '02',bodycard:
                    Column(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: ListTile(
                            leading: Text('-',style: TextStyle(color: Colors.grey)),
                            trailing: SizedBox.shrink(),
                    ...
                    GestureDetector(
                      ...
                      child: ListTile(
                        leading: Text('03',style: TextStyle(color: Colors.grey)),
                        trailing: SizedBox.shrink(),
      ...
      children: [
        ExpansionPanel(
          ...
          headerBuilder: (BuildContext context, bool isExpanded) {
            return ListTile(
              leading: Text(widget.number, style: TextStyle(color: Colors.grey),),
